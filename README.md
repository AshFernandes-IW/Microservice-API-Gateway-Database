...
4. Send the ``deleteCustomer`` request. Make sure you enter the correct ID at the end of the URL. This can be located from our list as given from the ``getCustomer`` request. This will delete the data from that list. The status code should be ``204 No Content``
